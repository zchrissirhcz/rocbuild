...
if((NOT OVERLOOK_WITH_C) AND (NOT OVERLOOK_WITH_CXX))
  message(WARNING "Neither C nor CXX compiler available. No OVERLOOK C/C++ flags will be set")
  message(WARNING "You may specify C and CXX in `project()` command")
  return()
endif()
...
if((CMAKE_C_COMPILER_ID STREQUAL "GNU") OR (CMAKE_C_COMPILER_ID MATCHES "Clang"))
  ...
  if(ignore_all_warnings)
    message(FATAL_ERROR "Found `-w` compile options, it ignore all warnings. Please remove it (in `add_compile_options)`")
  endif()
endif()
...
# android arm64 表现为 trap: https://zhuanlan.zhihu.com/p/587673235
# centos 升级 GCC 遇到 SIGSEGV: https://ttf248.life/p/升级gcc版本导致程序崩溃代码不规范的隐患
# https://pvs-studio.com/en/blog/posts/cpp/0917/ https://godbolt.org/z/dqqYqsj5E
if(CMAKE_C_COMPILER_ID STREQUAL "MSVC")
...
if(CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
  list(APPEND OVERLOOK_CXX_COMPILE_OPTIONS /we4297)
elseif(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
  if(CMAKE_CXX_COMPILER_VERSION GREATER_EQUAL 11.3)
